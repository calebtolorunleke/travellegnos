...
const Header = () => {
  return (
    <main className="h-screen flex flex-col">
      <div className="flex flex-row justify-between items-center text-white py-3 px-12 bg-gray-600">
      ...
      <div className="w-full h-full flex items-center justify-center bg--100">
